...
switch CaseNumber
   ...
   case 3
        ...
        display('Exercise task: Find a case the showcases ambiguity by adequately replacing the XXX.')
        % (Possible solutions in ../../Gravimetry/PrismForwardModel/)
        ...
        %The y-dimension is (but doesn not have to)
        %is symetric to the profile direction
        offsetz=[XXX XXX];offsetx=[XXX XXX]
